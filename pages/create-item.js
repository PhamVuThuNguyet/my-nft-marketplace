...
export default function createItem() {
    ...
    async function createSale(url) {
        ...
        contract = new ethers.Contract(ntfmarketaddress, NFTMarket.abi, signer)
    ...
    return (
        <div className='flex justify-center'>
            <div className='w-1/2 flex flex-col pb-12'>
                ...
                <input placeholder='Asset Price in Wei' className='mt-2 border rounded p-4' onChange={e => updateFormInput({ ...formInput, price: e.target.value })} />
